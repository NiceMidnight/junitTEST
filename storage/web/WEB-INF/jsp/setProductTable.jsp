    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                //{field: 'dictID', width: 100, title: '字典ID', sort: true,align:"center"},
                {field: 'dictTypeCode', minWidth: 150, title: '产品代码'},
                {field: 'dictTypeName',minWidth: 150,  title: ' 属性'},
                {field: 'dictItemName',minWidth: 150, title: '产品名称'},
