...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="hidden" name="orderEmployeeId" lay-verify="required" lay-reqtext="数量" placeholder="请输入数量" value="${Employee.employeeId}" class="layui-input" autocomplete="off">
        </div>
    </div>
